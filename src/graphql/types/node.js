...
const configInput = {
	name: 'NodeInputType',
	description: 'Node Schema base create input type',
...
const NodeType = createType(config);
const NodeInputType = createType(configInput);

export default NodeType;
export { NodeInputType };
